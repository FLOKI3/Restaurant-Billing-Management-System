...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Resturent Billing System - Samy_Akli")
        ...
        #=================================================billing menu=========================================================================================
        billing_menu=LabelFrame(self.root,text="Billing Summery- Samy_Akli",font=("Arial Black",12),relief=GROOVE,bd=10,bg="#A569BD",fg="white")
